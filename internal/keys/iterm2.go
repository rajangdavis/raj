...
func ITerm2Profile(name string) string {
	...
	// JSON has no comments, so the stamp rides on a real profile key. iTerm2
	// shows Description in the profile list, which makes it visible in the one
	// place a user would look to ask where this profile came from.
	sb.WriteString(fmt.Sprintf("      \"Description\": %q,\n",
		"generated by raj — do not edit by hand — "+HashMarker+Hash()))
