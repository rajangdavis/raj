...
None is scheduled; the working agreement at the top of RECURSIVE-RAJ.md applies.
...
### Reconciliation UX — layer selection and conflict navigation (2026-09-15, from the folded-in reconciliation-UX direction)

How overlapping agent edits and the human's become visible and resolvable.
Companion to this Direction section (2026-09-13); not scheduled, and it
inherits the working agreement at the top of `docs/RECURSIVE-RAJ.md`.
...
(`docs/REVIEW-AGENT.md`, `docs/RECURSIVE-RAJ.md` §7b), the arbiter of "this set
